...
public class PhaseFive extends Phase {
    ...
    public PhaseFive(ApplicationResources applicationResources, PlayerActor player, WaterActor water, Stage uxStage, int currentLevel) {
        ...
        TiledMapTileLayer speechLayer = (TiledMapTileLayer) tiled.getLayers().get("PhaseFive");
