...
public class PhaseFour extends Phase {
    ...
    public PhaseFour(ApplicationResources applicationResources, PlayerActor player, WaterActor water, Stage uxStage, int currentLevel) {
        ...
        TiledMapTileLayer speechLayer = (TiledMapTileLayer) tiled.getLayers().get("PhaseFour");
