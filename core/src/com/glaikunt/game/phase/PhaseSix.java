...
public class PhaseSix extends Phase {
    ...
    public PhaseSix(ApplicationResources applicationResources, PlayerActor player, WaterActor water, Stage uxStage, int currentLevel) {
        ...
        TiledMapTileLayer speechLayer = (TiledMapTileLayer) tiled.getLayers().get("PhaseSix");
